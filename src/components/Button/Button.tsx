...
const buttonVariants: Record<ButtonVariant, TwStyle> = {
	...
	[ButtonVariant.SECONDARY]: tw`bg-transparent text-black border border-black border-solid hover:bg-black/20 disabled:border-black/50 disabled:text-black/50`,
